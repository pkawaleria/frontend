...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.AuctionDetailedResponse();
  });
  ...
  describe('AuctionDetailedResponse', function() {
    it('should create an instance of AuctionDetailedResponse', function() {
      // uncomment below and update the code to test AuctionDetailedResponse
      //var instance = new OpenApiDefinition.AuctionDetailedResponse();
      //expect(instance).to.be.a(OpenApiDefinition.AuctionDetailedResponse);
    });
    ...
    it('should have the property auctioneerId (base name: "auctioneerId")', function() {
      // uncomment below and update the code to test the property auctioneerId
      //var instance = new OpenApiDefinition.AuctionDetailedResponse();
      //expect(instance).to.be();
    });
