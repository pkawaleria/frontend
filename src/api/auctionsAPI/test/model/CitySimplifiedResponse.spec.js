...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.CitySimplifiedResponse();
  });
  ...
  describe('CitySimplifiedResponse', function() {
    it('should create an instance of CitySimplifiedResponse', function() {
      // uncomment below and update the code to test CitySimplifiedResponse
      //var instance = new OpenApiDefinition.CitySimplifiedResponse();
      //expect(instance).to.be.a(OpenApiDefinition.CitySimplifiedResponse);
    });
