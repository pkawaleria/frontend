...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.UpdateAuctionRequest();
  });
  ...
  describe('UpdateAuctionRequest', function() {
    it('should create an instance of UpdateAuctionRequest', function() {
      // uncomment below and update the code to test UpdateAuctionRequest
      //var instance = new OpenApiDefinition.UpdateAuctionRequest();
      //expect(instance).to.be.a(OpenApiDefinition.UpdateAuctionRequest);
    });
