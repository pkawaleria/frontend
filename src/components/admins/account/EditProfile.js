        ...
        <div className="flex items-center justify-center p-5 gradient-bg-color-only h-screen">
            <div
                ...
                <div className="flex justify-end w-full mt-4">
                    <button
                        className="nav-link absolute bottom-1 right-1 bg-green-500 dark:bg-green-800 dark:hover:bg-green-700 text-white py-3 px-4 rounded-full hover:bg-green-600 easy-linear duration-200 focus:outline-none"
                ...
                {isConfirmationModalOpen && (
                    <div className="fixed inset-0 flex items-center justify-center z-50">
                        ...
                        <div
                            className="relative bg-white dark:bg-neutral-600 w-1/2 rounded-lg shadow-md p-8 opacity-100">
                            <p className="text-lg dark:text-neutral-200 font-semibold mb-4 text-center">Czy na pewno
                                chcesz zaktualizować dane?</p>
