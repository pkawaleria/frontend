  ...
  return (
    <div className="flex flex-col items-center justify-center p-5 gradient-bg-color-only h-[80%]">
      ...
      <div className="w-[60%] max-w-screen-md bg-white rounded-lg shadow-xl p-6 relative">
        ...
        <Link
          className="nav-link absolute top-1 right-1 bg-blue-500 text-white py-3 px-3 rounded-full hover:bg-blue-600 easy-linear duration-200 focus:outline-none"
        ...
        <Link
          className="nav-link absolute bottom-1 right-1 bg-red-500 text-white py-3 px-3 rounded-full hover:bg-red-600 easy-linear duration-200 focus:outline-none"
          to="/wyloguj"
        ...
        <Link
          className="nav-link absolute bottom-1 right-14 bg-yellow-500 text-white py-3 px-3 rounded-full hover:bg-yellow-600 easy-linear duration-200 focus:outline-none"
