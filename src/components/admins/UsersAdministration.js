                                ...
                                <div className="ml-4">
                                    ...
                                    <div className="flex justify-left">
                                        <Link
                                            ...
                                            <BsInfoCircle
                                                className="bg-blue-400 text-white rounded-full hover:bg-blue-700 easy-linear duration-200 focus:outline-none"
                                                size={22}
                                            />
                                            <Tooltip
                                        ...
                                        {user.isBanned === true ? (
                                            ...
                                            >
                                                <BiBlock
                                                    className="bg-red-300 text-white rounded-full hover:bg-red-700 easy-linear duration-200 focus:outline-none"
                                                    size={22}
                                                />
                                                <Tooltip
