...
const CurrentUserMostViewedAuctions = () => {
    ...
    useEffect(() => {
        auctionMsApi
            .get('/auction-service/viewed-auctions/most-views')
            .then((response) => {
    ...
    return (
        <div className="w-8/12 mx-auto mt-10 content-center">
            <div className="mb-4 header bg-blue-700/50 dark:bg-neutral-700" onClick={toggleCollapse}>
                <p className={`${isFontLarge ? "text-5xl" : "text-3xl"} ease-linear duration-100 text-white font-semibold`}>
                    Twoje ulubione aukcje
                </p>
                {isExpanded
