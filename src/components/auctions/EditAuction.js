                ...
                <form className="bg-white dark:bg-neutral-600 py-3 px-8 border-0 w-2/3 self-center">
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-[80%] p-2 border border-blue-500 dark:bg-neutral-300/30 dark:text-neutral-50 dark:border-neutral-200 dark:focus:border-blue-500 rounded-md focus:outline-none focus:border-blue-500 ${titleError ? "border-red-500 dark:border-red-500" : ""
                                }`}
                            required
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-[50%] p-2 border border-blue-500 dark:bg-neutral-300/30 dark:text-neutral-50 dark:border-neutral-200 dark:focus:border-blue-500 rounded-md focus:outline-none ${phoneNumberError ? "border-red-500 dark:border-red-500" : ""
                                }`}
                            required />
                        {phoneNumberError && <p className="text-red-500">{phoneNumberError}</p>}
                    </div>
                    <div className="mb-4">
                        <TbMoneybag size={25} className="inline-block mr-2 dark:text-neutral-50" />
                        <label
                            htmlFor="price"
                            className="block text-gray-600 dark:text-neutral-300 font-medium mb-2">
                            Cena:
                        ...
                        <input
                            ...
                            className={`w-[50%] p-2 border border-blue-500 dark:bg-neutral-300/30 dark:text-neutral-50 dark:border-neutral-200 dark:focus:border-blue-500 focus:border-blue-500 rounded-md focus:outline-none ${priceError ? "border-red-500 dark:border-red-500" : ""
                                }`}
                            required/>
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="relative bg-white dark:bg-neutral-600 w-1/2 rounded-lg shadow-md p-8 opacity-100">
                        <p className="text-lg dark:text-neutral-200 font-semibold mb-4 text-center">
                            Czy na pewno chcesz zaktualizować aukcję?
                        </p>
