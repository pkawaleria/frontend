...
export default function LoggedInUserNavbar( {userName} ) {
        ...
        <div className="w-[25%] flex flex-row mx-auto">
          ...
          <div className="w-[40%] text-white hover:text-gray-400 grid grid-flow-col gap-3">
            ...
            <Link
              ...
              data-tooltip-content={`Witaj ${userName}`}>
              <BiUser className="mx-auto icon-hover text-[2.5vw] ease-linear duration-200" />
              <Tooltip
                id="profile"
                type="dark"
                effect="solid"
