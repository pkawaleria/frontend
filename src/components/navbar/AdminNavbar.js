...
export default function AdminNavbar() {
  ...
  return (
    <nav
      className={`h-[10%] navbar navbar-expand-md navbar-dark sticky top-0 ${
        visible ? " navbar-show" : " navbar-hidden"
      }`}
    ...
    >
      <div className=" border-2 border-white rounded-md bg-custom-blue shadow-3xl w-2/3 mx-auto my-5 flex  items-center">
        ...
        <h1 className="text-white font-bold text-[2.5vw] w-[80%] text-center">
          Ogłoszeniowo
        </h1>
        ...
        <div className="w-[10%] flex items-center">
          {decodedToken && decodedToken.roles === "USER" ? (
            <Link
              className="nav-link w-full"
              to="/profil"
              data-tooltip-id="accountTooltip"
              data-tooltip-content="Moje konto"
            >
            ...
            <Link
              ...
              to="/profil/admin"
              data-tooltip-id="accountTooltip"
              data-tooltip-content="Moje konto (Admin)"
            >
              <BiUser className="m-auto icon-hover text-white text-[2.5vw] hover:text-[3vw] ease-linear duration-200" />
              <Tooltip
                id="accountTooltip"
