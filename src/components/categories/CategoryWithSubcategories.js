...
const CategoryWithSubcategories = () => {
    ...
    return (
        <div className="w-[90%] md:w-8/12 lg:w-8/12 mx-auto space-y-4 mb-4">
            <div className="w-full shadow-xl rounded-lg bg-white dark:bg-neutral-600 p-4 border-t-4 border-indigo-500 dark:border-neutral-100">
                ...
                <button
                    ...
                    className="bg-blue-600 dark:bg-blue-900 dark:hover:bg-blue-800 text-white py-1 px-3 rounded mr-2 hover:bg-blue-700"
                >
                    Pokaż aukcje
                </button>
                {isAdmin && (
                    <>
                        ...
                        <button className="bg-blue-400 text-white py-1 px-3 rounded hover:bg-blue-500">Wyświetl szczegóły</button>
                    </>
                )}
                <div className="mt-2">
                    <small className="text-gray-400 dark:text-neutral-300">
