    ...
    return (
        <div className="grid grid-cols-3 gap-8 p-8">
            {categories.map(category => (
                <div
                    key={category.id}
                    className="bg-gray-200 dark:bg-neutral-600 dark:text-neutral-200 p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 cursor-pointer"
